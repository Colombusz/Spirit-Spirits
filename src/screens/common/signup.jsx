...
const Signup = () => {
  ...
  const handleSignup = () => {
    ...
    // Create an address object from the new fields
    const address = { street, city, postalCode, country };

    // Dispatch signup action with extra fields
    dispatch(signupUser({ 
      username, 
      firstname, 
      lastname, 
      ...
      address, 
      phone, 
      image: capturedPhoto ? { url: capturedPhoto } : {} 
    }))
      .unwrap()
      .then((user) => {
          ...
          <View style={styles.photoSection}>
            {capturedPhoto ? (
              ...
              <View style={styles.placeholderContainer}>
                <Ionicons name="person-circle-outline" size={80} color={colors.bronzeShade4} />
              </View>
            )}
...
const styles = StyleSheet.create({
  ...
  section: {
    ...
    borderWidth: 1,
    borderColor: colors.bronzeShade3 + '40', // Adding some transparency
    shadowColor: colors.bronzeShade6,
  ...
  sectionTitle: {
    ...
    marginBottom: spacing.medium,
    borderBottomWidth: 1,
    borderBottomColor: colors.bronzeShade2 + '30',
    paddingBottom: 8,
  },
  rowContainer: {
    flexDirection: 'row',
  ...
  input: {
    ...
    borderWidth: 1,
    borderColor: colors.bronzeShade2 + '60',
    borderRadius: 8,
    padding: 12,
    fontSize: 16,
    color: colors.text,
  ...
  placeholderContainer: {
    ...
    marginBottom: spacing.medium,
    borderWidth: 1,
    borderColor: colors.bronzeShade3 + '40',
  },
  photoButton: {
